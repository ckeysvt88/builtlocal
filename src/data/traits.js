...
export const TRAIT_LABELS = {
  ...
  p12:"12 Personnel (2 TE)", p13:"13 Personnel (3 TE)", p20:"20 Personnel (2 RB, 3 WR)", p21:"21 Personnel (2 RB)", p22:"22p Heavy / Power",
...
export const TRAITS = [
  ...
  { id: "personnel", label: "His Personnel", icon: "👥", items: [
    ...
    { id: "p20", label: "20p (2 RB, 3 WR — Spread Power)" }, { id: "p21", label: "21p (2 RB, 1 TE)" },
